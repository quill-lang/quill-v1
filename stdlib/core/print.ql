...
def print_int: Int -> Unit {
    print_int n = if_lazy (ge_int 10 n) (print_int_large n) (print_int_small n)
}

def print_int_large: Int -> Unit -> Unit {
    print_int_large n _ = (
        let quot = div_int_unchecked n 10
        let rem = sub_int_unchecked n (mul_int_unchecked quot 10)
